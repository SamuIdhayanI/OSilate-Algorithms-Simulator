...
public class MRUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mruactivity);
        ...
        go_to_content.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MRUActivity.this, MRU_example.class);
        ...
        simulateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < references.length; i++) {
                    ...
                    TableRow row = new TableRow(MRUActivity.this);
                    TextView referenceTextView = new TextView(MRUActivity.this);
                    referenceTextView.setText(reference);
                    referenceTextView.setPadding(16, 16, 16, 16);
                    row.addView(referenceTextView);

                    for (int j = 0; j < numFrames; j++) {
                        TextView frameTextView = new TextView(MRUActivity.this);
