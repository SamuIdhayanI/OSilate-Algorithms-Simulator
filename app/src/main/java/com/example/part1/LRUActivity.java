...
public class LRUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lruactivity);
        ...
        go_to_content.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LRUActivity.this, LRU_example.class);
        ...
        simulateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < references.length; i++) {
                    ...
                    TableRow row = new TableRow(LRUActivity.this);
                    TextView referenceTextView = new TextView(LRUActivity.this);
                    referenceTextView.setText(reference);
                    referenceTextView.setPadding(16, 16, 16, 16);
                    row.addView(referenceTextView);

                    for (int j = 0; j < numFrames; j++) {
                        TextView frameTextView = new TextView(LRUActivity.this);
